...
const Icon = ({ name, color }: { name: string, color: string }) => {
  const paths: Record<string, string> = {
    ...
    // PHP
    php: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm1.25 12.25h-2.5v-1.5h1.25c.69 0 1.25-.56 1.25-1.25s-.56-1.25-1.25-1.25H10.75v-1.5h1.25c1.25 0 2.25 1 2.25 2.25s-1 2.25-2.25 2.25z",

    // LARAVEL
    laravel: "M2 6h4v12H2V6zm6 0h4v6l4 6h-4l-4-6V6zm10 0h4v12h-4V6z",
